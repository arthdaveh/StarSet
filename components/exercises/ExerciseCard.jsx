        ...
        {isRenaming ? (
          ...
          <>
            ...
            <Pressable
              ...
              style={({ pressed }) => [
                { opacity: pressed ? 0.5 : 1 }, // 👈 fade effect when pressed
              ]}
            >
              <Text style={styles.cardTitle}>{name}</Text>
            </Pressable>
...
const styles = StyleSheet.create({
  ...
  saveRightWrapper: {
    flexGrow: 1, // take the rest of the row width

    // optional: keep spacing consistent with the inputs
    // marginRight: 0,    // tweak if you need a tiny gutter
  },

  dotBox: {
    width: 5, // pick a small constant that looks good
